...
public class TrainHMM {
    ...
    private static void print() throws FileNotFoundException, IOException, ClassNotFoundException {
        ...
        testData.addThruPipe(new LineGroupIterator(new BufferedReader(
                new InputStreamReader(new FileInputStream("E:\\thien\\Learning\\"
                        + "NLP\\Project\\Data\\Tests\\v2\\Test1\\Test.txt"))),
...
//        TrainHMM trainer = new TrainHMM("E:\\thien\\Learning\\NLP\\Project\\Data\\Tests\\v2\\Test1\\Train.txt",
